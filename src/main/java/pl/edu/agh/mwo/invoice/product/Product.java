...
public abstract class Product {
	...
	//szybkie sprawdzenie czy takie same
	//losowe ale unikalne dla obiektow hashe
	@Override
	public int hashCode() {
		final int prime = 31;
		int result = 1;
	...
	//porowaninie czy dwie instancje sa takie same
	@Override
	public boolean equals(Object obj) {
		...
		if (taxPercent == null) {
			...
			return false;
		//if dojedziemy tutaj == produkty takie same
		return true;
	}
